        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
                   ...
                   <div class="col-md-12 content_agency">
                    <div><h1 class="title_iseg_town">En quête de pub : Sous les jupons de la communication !</h1></div>
                    <div class="row">
                    ...
                    <div class="row row_style_iseg">
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10h00 :</span> Table Ronde
« Les ingrédients de la réussite d’Alouette, 1ère radio régionale de France ! »
Avec Bertrand De Villiers, président de Alouette, Jean-Christophe Ruello, attaché de direction, Alex 2 C, animateur.
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">15h00 :</span> Conférence
« La publicité dans le sport ! »
Avec Clément Meunier, journaliste sportif France 2, chez France Télévision.
</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">11h30 :</span> Présentation du livre « Brand Success »
« Les 50 réussites exceptionnelles du marketing et de la communication ! »
Avec Marc Drillech, directeur général IONIS Education Group et auteur de l’ouvrage.

                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">12h30 :</span> Déjeuner ADETEM Grand Ouest
« Dédicace du livre Brand Success »
Avec Marc Drillech, directeur général IONIS Education Group et auteur de l’ouvrage.
</p>
                          </li>
                          ...
                          <li>
                              <p><span class="horaires_iseg">15h00 :</span> Conférence
« Dans les coulisses d’une communication institutionnelle. »
Avec Vanina Patriarche, chef de la division multimédia, au sein de l’Assemblée Nationale.
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">15h00 :</span> Atelier
« Une communication qui déchire ! »
Avec Christophe Weber, directeur marketing et communication chez SIXT.

                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">17h30 :</span> Invitée de la semaine
« Success story d’une directrice conseil made in Gingerminds ! »
Avec Nathalie Rabin, directrice conseil associée de l’agence Gingerminds.
</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">15h30 :</span> Cocktail

                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">16h00 :</span> Animation ludique
« AdMovie Challenge. »
Réalisation d’un spot publicitaire humoristique et décalé.

</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">14h :</span> Conférence avec Ubereats (à confirmer)
                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg"> 16 h :</span> Conférence
                            <i>« Quel avenir pour la radio ? »</i> 
                            Par Aino SCHLAEGEL directeur Radio Nova Bordeaux.
                          ...
                          <li>
                              <p><span class="horaires_iseg">10 h :</span> Conférence
                          <i>« Le foot rassemble, les réseaux sociaux unissent »</i>
                          Avec Pierre FARGES, Community Manager des Girondins de Bordeaux.
                          ...
                          <li>
                              <p><span class="horaires_iseg">11h30 :</span> Clôture de la semaine + passage de flambeau aux étudiants de première année.
                          </p>
                          </li>
                      ...
                      <div class="row row_style_iseg">
                      <div><h2 class="title_iseg">VENDREDI 31 MARS</h2></div>
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">15h00 :</span> Conférence
« Les dessous entre les marques et les nouveaux influenceurs ! »
Avec Cécile Gayraud, agent d’influenceurs, Nail Art is Easy.
