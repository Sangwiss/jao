        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
                   ...
                   <div class="col-md-12 content_agency">
                    <div><h1 class="title_iseg_town">Programme de Bordeaux</h1></div>
                    <div class="row">
                    ...
                    <div class="row row_style_iseg">
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">8h :</span> Distribution de journaux <i>« 20 minutes »</i> annonçant le programme</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">10h :</span> Présentation de la semaine en amphi + petit déjeuner</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">10h30 :</span> Conférence
                          <i>« Le sport comme vecteur de communication pour mieux vivre ensemble »</i>
                          Avec Elisa MADIOT GAGNIER, Sports Communication and PR Manager.
                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg">14 h :</span> Conférence
                            <i>« La presse gratuite est-elle une presse d’information ? »</i>
                            Avec Hugues SEILLAN, chef de Marché « 20 Minutes ».
                          ...
                          <li>
                              <p><span class="horaires_iseg">14 h :</span> Conférence 
                            <i>« La presse gratuite est-elle une presse d’information ? »</i>
                            Avec Hugues SEILLAN, chef de Marché <i>« 20 Minutes »</i>.
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          ...
                          <i>« À quoi sert l’agence Média aujourd’hui ? »</i>
                          Avec Mélanie SEVILLA Conseil stratégie achat media-Fondatrice Middle Bo.
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">Après-midi :</span> Agences ouvertes
                              Visite des locaux de France 3 pour 15 étudiants préalablement sélectionnés via un concours Facebook.</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          ...
                          <i>« Jusqu’où va la liberté de la pub ? »</i>
                          Par Elisa Chocron de l’ARPP.
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">12 h :</span> Déjeuner organisé en partenariat avec l’association WEAREISEG + stand Ubereats</p>
                          </li>
