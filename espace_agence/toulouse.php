        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
                   ...
                   <div class="col-md-12 content_agency">
                    <div><h1 class="title_iseg_town">Sport et séduction : les marques entrent en compétition !</h1></div>
                    <div class="row">

                    </div>

                    <div class="row row_style_iseg">
                      <div><h2 class="title_iseg">Lundi 27 mars</h2></div>
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10h30-11h30 :</span> Conférence « La com’ en piste »
« Quelle communication des stations de ski et quelle organisation des évènements sportifs de haut niveau ? »
Avec Sarah Gomez, responsable commerciale de Vallnord. Cette station de ski et Bike Park d’Andorre accueille la UCI Mountain Bike World Cup et le Freeride World Tour.
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">18h-19h30 :</span> Préparez vos questions et votre meilleure répartie. Mettez-vous dans la peau de journalistes sportifs et interviewez René Bouscatel, 
                                président du Stade Toulousain.</p>
                          </li>
                      ...
                      <div class="row row_style_iseg">
                      <div><h2 class="title_iseg">MARDI 28 MARS</h2></div>
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">9h-20h :</span> Journée Agences Ouvertes
En partenariat avec l’AACC, découvrez l’univers des plus belles agences de communication toulousaines. Choisissez votre équipe !

                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">19h-22h :</span> Soirée interne : « 3ème mi-temps »
En interne, les étudiants seront conviés à participer à un tournoi FIFA. 
La soirée se poursuivra avec la diffusion en direct du match France-Espagne !
</p>
                          </li>
                      ...
                      <div class="row row_style_iseg">
                      <div><h2 class="title_iseg">MERCREDI 29 MARS</h2></div>
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">11h-12h30 :</span> Masterclass : « Coupure Pub »
« Quelle place de la radio dans la communication interne ? Retour sur une success-story toulousaine. »
Avec Anne-Marie de Couvreur, présidente et cofondatrice de Mediameeting, leader des opérateurs de radios d'entreprises.

                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">13h-14h :</span> Drink & Discuss : « À fond la forme ! »
« Comment réussir à intégrer le milieu sportif après ses études ? »
Retour d’expérience de Chloé Costa, responsable de rayon chez Décathlon et diplômée 2015.
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">15h-16h :</span> Conférence : « Autour du shaker »
« Comment la marque réussit-elle à se faire une place dans l’univers du sport avec l’émergence de nouvelles pratiques ? »
Avec Emie Livet, distributrice chez Herbalife, marque de compléments alimentaires.

                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg"> 18h-19h :</span> Afterwork : « Temps additionnel »
« Comment utiliser le digital au service de l’image de marque ? » 
Avec Ali Khalef, chargé de développement web marketing du TFC.
                       ...
                       <div class="row row_style_iseg">
                      <div><h2 class="title_iseg">JEUDI 30 MARS</h2></div>
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10h-11h :</span> Conférence : « Com’ tout terrain »
« Quelles sont les best practices de communication pour un club sportif ? »
Avec Laurie Delagnes, chef de projet pub de l’agence BMV Communication.
                          ...
                          <li>
                              <p><span class="horaires_iseg">18h30-19h30 :</span> Conférence : « La Grande Finale »
« La communication, un atout majeur de valorisation d’événements sportifs. »
Avec David Rigot, Directeur Adjoint de la communication de TF1.
