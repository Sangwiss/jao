        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
                   ...
                   <div class="col-md-12 content_agency">
                    <div><h1 class="title_iseg_town">Productising, Native Advertising, Brand Content… : c’est pas sorcier ! </h1></div>
                    <div class="row">
                    ...
                    <div class="row row_style_iseg">
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">9h30 :</span> Conférence d’ouverture 
« Le productising, nouvelle manière de créer le buzz ? »
Animée par les parrains de la semaine : François Phan, Head of Digital & Innovation, et Julien Scaglione, Head of Social Media chez Buzzman
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">12h30 :</span> Jeu : « Done or not ? »
Saurez-vous reconnaître, en équipes, les vraies actions de productising des fausses ? (lieu : hall Parmentier)
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">14h30 :</span> Conférence
« Tops & flops du Brand Content et du Native Advertising »
Animée par David MURGUET, Responsable Native Ad & Brand Content chez Topito.com
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10h :</span> Conférence 
« La problématique du plagiat, de l’originalité et de la difficulté d’innover dans la communication »
Animée par Joe La Pompe, Blogueur Chroniqueur et Conférencier.

                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">14h00 :</span> 8ème édition de la Journée Agences Ouvertes
Organisée par l’Association des Agences-Conseils en Communication.
</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">12h30 :</span> Animation (dans le hall)
« Olfactory Quizz ».
Venez nombreux jouer avec le marketing sensoriel : sentez, trouvez, gagnez !
                          ...
                          <li>
                              <p><span class="horaires_iseg">14h30 :</span> Conférence
« Les chaussons LEGO : l'exemple incontournable du Productising »
Animée par Tatiana Ferré Sentis, Account Planner Chez Brand Station Paris, et Julien Vélu, Social Media Manager chez X-Prime.
</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">8h30 :</span> Petit déjeuner des Anciens
Échanges avec d’anciens d’élèves de l’ISEG Marketing & Communication School qui ont intégré le monde de la communication et des médias.
                          ...
                          <li>
                              <p><span class="horaires_iseg">12h30 :</span> Animation
Résultat du concours photo et remise des lots.

</p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg">13h30 :</span> Pot de clôture
Projection des meilleurs moments de la Semaine Evénement.
