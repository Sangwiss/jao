        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
              ...
              <div  class="col-md-8 cover">
                <div  class="col-md-8 correctbanner" ><img class="img_cover"  src="/espace_agence/medias/banniere_jao.jpg"/></div>

             <div class="col-md-4 profil_pic_concept correct2">
                 <h2 class="concept_pic">#JAO2017, la communication citoyenne à l’honneur !</h2><p class="bebas"></p></div></div>
              ...
              ?>
                   ...
                   <div class="col-md-8 content_agency">
                    <div class="row">
                      <p class="concept_p">
                        <b>L’Association des Agences-Conseils en Communication</b> (AACC) organise <b>le mardi 28 mars 2017 la 7ème édition de la journée Agences Ouvertes</b> et met en avant le <b>rôle citoyen des agences</b>.

Cette nouvelle journée entièrement consacrée à la communication donnera l’occasion de découvrir toute la richesse et la créativité des agences-conseils en communication.</p>
 
<p class="concept_p">Cette année, les agences pourront présenter leurs actions de communication citoyenne et témoigner qu’elles mobilisent leur créativité pour des marques, des causes et des innovations qui changent notre société. Une occasion unique pour les <b>étudiants, annonceurs, institutions, médias, futurs collaborateurs</b> de plonger dans l’atmosphère créative des agences de communication.</p>

<p class="concept_p">Happenings, conférences, concours, projections, expositions… Découvrez les programmes et surtout, pensez à vous inscrire auprès des agences participantes !<br>
