...
echo '
  ...
  <a href="fiche-agence.php?id='.$programme['user_id'].'">
    <div class="item-box thumbnail card-wrapper "><div class="image">';
            if ($programme['image'] != "" && file_exists('medias/'.$programme['image'])) {
              echo '<img alt="banniere" src="/espace_agence/medias/'.rawurlencode($programme['image']).'" class="card-image im">
          </div></div>';
            }
            else if ($programme['logo_agence'] != "" && file_exists('uploads/'.$programme['logo_agence'])) {
            ...
            var_dump($programme);
            echo '-->';
            echo '<!-- uploads/'.$programme['logo_agence'].' medias/'.$programme['image'] .'--><div class="card-label-and-text"><div class="card-label">
...
<div class="row container-grid nf-col-3">
              <div class="col-md-12 little_search_bar2">
 <h2 class="title-little-search-bar2">LES AGENCES PARTICIPANTES</h2></div>
               </div>
            ...
            <div class="row little_search_bar">
              ...
              <div class="col-md-2  col-sm-2"><a class="link_little_search_bar contours_search" href="recherche.php">Régions</a></div>
              <div class="col-md-3  col-sm-3"></div>
            </div>
        </div>
