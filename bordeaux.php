                    ...
                    <div class="row row_style_iseg">
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          ...
                          <li>
                              <p><span class="horaires_iseg">10h :</span> Accueil et présentation de la semaine</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">10h30 :</span> Conférence « Le sport comme vecteur de communication pour mieux vivre ensemble » Avec Elisa MADIOT GAGNIER, Sports Communication and PR Manager.
                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg">14 h :</span> Conférence « La presse gratuite est-elle une presse d’information ? » Avec Hugues SEILLAN, chef de Marché « 20 Minutes ».
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10h :</span> Conférence « Communiquer sur internet, c’est mon choix ! » Avec Aude Verquerre, Zest Marketing Conseil en stratégie marketing.
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">12H :</span> Visite des locaux de France 3 pour 15 étudiants préalablement sélectionnés via un concours Facebook.</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">Après-midi :</span> Rencontre avec les Agences ouvertes</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10 h :</span> Conférence « Jusqu’où va la liberté de la pub ? » Par Elisa Chocron de l’ARPP.
                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg"> 16 h :</span> Conférence « Quel avenir pour la radio ? » Par Aino SCHLAEGEL directeur Radio Nova Bordeaux.
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10 h :</span> Conférence « Le foot rassemble, les réseaux sociaux unissent » Avec Pierre FARGES, Community Manager des Girondins de Bordeaux.
                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg">11h30 :</span> Clôture de la semaine
