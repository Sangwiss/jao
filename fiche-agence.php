            ...
            <div class="container">
              ...
              <div class="col-md-4 profil_pic correct">
                  <?php
                    ...
                    if ($programmes[0]['heure_globale_debut'] != '' && $programmes[0]['heure_globale_fin'] != '') {
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    ...
                    echo '
                        ...
                        $query = "SELECT * FROM intervenants WHERE event_id = ?";
                        $sql = $dbh->prepare($query);
                        $sql->execute(array($programme['id']));
                        $intervenants = $sql->fetch();

                        $i = 1;

                        // ALLER redesign-moi tout ça !

                        while ($i <= 5) {

                          echo '

                          <div class="better-intervenants">
                          <p class="better-intervenants-cas"><b>'.$intervenants['prenom_'.$i].' '.$intervenants['nom_'.$i].'</b></p>
                          <p class="better-intervenants-cas"><i>'.$intervenants['fonction_'.$i].'</i></p>
                          <p class="better-intervenants-cas"><b>'.$intervenants['societe_'.$i].'</b></p></div>';
                          $i++;
                        }
                 ...
                 <div class="row">
                    ...
                    <div style="padding: 0px;" class="col-md-8 adress_back">
                      <div style="width: 50%;" class="col-md-4 adress_back">
                        ...
                        <p class="adress_p"><?php echo $user['cp']; if ($user['ville'] != ''){ echo ', '.$user['ville']; } ?></p>
                        <?php
                          ...
                          <p class='adress_p'>
                            <?php
                              ...
                              if ($user['adresse'] != '' || $user['ville'] != '') {
                                echo "<br/><i  style='padding-right: 5px;' class='fa fa-calendar' aria-hidden='true'></i><a href='http://maps.apple.com/maps?q=".htmlentities($user['adresse']).", ".htmlentities($user['ville'])."'>Voir Plan</a>";
                              }
                            ?>
                          </p>
                      ...
                      <div style="height: 540px;/* color: black; */background-color: white;width: 50%;" class="col-md-4" id="map">
                        <script>
                          $(document).ready(function() {
                            ...
                            geocoder.geocode( { 'address': "<?php echo $user['adresse'].", ".$user['ville']; ?>"}, function(results, status) {
