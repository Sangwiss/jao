        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
                   ...
                   <div class="col-md-12 content_agency">
                    <div><h1 class="title_iseg_town">Programme de la Semaine Pub, Com, Médias du 27 au 30 mars</h1></div>
                    <div class="row">
                    ...
                    <div class="row row_style_iseg">
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">17h00 :</span> Table ronde autour de l’avenir de la communication  avec l’UCCA Grand Est</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">Journée Agences Ouvertes</span> Visites d’agences toute la journée
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">11h00</span> Rencontre avec l’agence France Medien Partner pour une présentation de l’achat d’espace en régie.</p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg">18h00</span> Projection de « 99 francs » par l’association Movies & Chill</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p>Élection de la meilleure communication d’Alsace Off et on line</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">18h00</span> Rencontre avec l’agence Novembre pour la campagne Lidl « On est mal, patron »</p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          ...
                          <li>
                              <p><span class="horaires_iseg">18h00</span> Rencontre avec l’agence Mediaveille pour la valorisation des campagnes WEB</p>
                          </li>
