        ...
        <section  style="padding-bottom: 0px" class="ptb ptb-sm-80 content_padding">
            <div class="container">
                   ...
                   <div class="col-md-12 content_agency">
                    <div><h1 class="title_iseg_town">Programme de Lyon</h1></div>
                    <div class="row">
                    ...
                    <div class="row row_style_iseg">
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">11h30-13h00 :</span> Conférence « Brand Success » animée par Marc Drillech, Président de IONIS Education Group</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">13h00-14h00 :</span> Cocktail</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">14h00-15h00 :</span> Conférence animée par Jean-François Granat (Président Club de la com Lyon et Directeur International de la communication chez Bluestar Silicones)
                          </p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">Journées Agences Ouvertes :</span> 8 agences ouvrent leurs portes.
                          </p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">13h00 :</span> accueil des futurs 1re année inscrits
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">14h00 :</span> conférence avec Christophe Mahé – PDG du Groupe Espace sur les raisons de son succès ainsi que les  rôles du marketing et de la com dans son entreprise
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">15h30-16h30 :</span> quizz sur les marques 
                          </p>
                          </li>

                           <li>
                              <p><span class="horaires_iseg">16h30 :</span> cocktail et remise des prix du quizz  et photos souvenirs.
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">14h00-15h00 :</span> tables rondes évènementiel avec L’Usine, l’Agence Conseil Particule et Le Sucre
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">16h00-17h00 :</span> table ronde Hard Rock Café 
</p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">15h30-16h30 :</span> cocktail  
                          </p>
                          </li>
                      ...
                      <div>
                        <ul class="list-unstyled ul_padding">
                          <li>
                              <p><span class="horaires_iseg">10h00-11h30 :</span> conférence 
                          </p>
                          </li>

                          <li>
                              <p><span class="horaires_iseg">12h00-13h00 :</span> cocktail de clôture
</p>
                          </li>
